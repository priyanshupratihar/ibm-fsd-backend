...
public class LoginController {
	...
	public ModelAndView authenticate(@ModelAttribute Login login, Model model, HttpSession session,HttpRequest request) {
		
		if(login.getUserName().equals(session.getAttribute("userName")) && login.getPassword().equals(session.getAttribute("password")))
		{
