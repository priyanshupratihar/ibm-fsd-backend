...
public static void addEmp() {
	...
	public static void main(String[] args) {
		...
		ts.add(new Employee("shivam",22,"fsd",35000,"Male"));
		ts.add(new Employee("rohit",28,"sales",37000,"Male"));
		ts.add(new Employee("priya",22,"atnt",45000,"Female"));
		ts.add(new Employee("Shivani",22,"FSD",45000,"Female"));
		System.out.println("Set before using the comparator: "+ ts);
		
		for (Object element : ts) 
			System.out.print(ts.comparator()); 
	}
